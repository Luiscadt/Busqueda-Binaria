...
if __name__ == '__main__':
    # Crear una lista ordenada con 1000 numeros aleatorios llamada mi_lista
    tamaño = 1000000
    ...
    fin = time.time()
    print(f"Tiempo de busqueda ingenua: {fin - inicio}") """

    #Medir el tiempo de busqueda binaria
    inicio = time.time()
    for objetivo  in lista_ordenada:
        busqueda_binaria(lista_ordenada, 45000)
    fin = time.time()
    print(f"Tiempo de busqueda binaria: {fin - inicio}")
